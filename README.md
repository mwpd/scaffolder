...
[![Travis CI](https://travis-ci.org/mwpd/scaffolder.svg?branch=master)](https://travis-ci.org/mwpd/scaffolder)
[![Scrutinizer Code Quality](https://scrutinizer-ci.com/g/mwpd/scaffolder/badges/quality-score.png?b=master)](https://scrutinizer-ci.com/g/mwpd/scaffolder/?branch=master)
[![Coverage Status](https://coveralls.io/repos/github/mwpd/scaffolder/badge.svg?branch=master)](https://coveralls.io/github/mwpd/scaffolder?branch=master)
...
| Feature                   | Setup
| ------------------------- | ----------------
| Collaborative repository  | [DONE](https://github.com/mwpd/scaffold)
| Linux permutation testing | [DONE](https://travis-ci.org/mwpd/scaffold)
...
- [GitHub issue templates](https://github.com/mwpd/scaffold/issues/templates/edit)
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [releases](https://github.com/mwpd/scaffold/releases) page.

## Authors

* **Alain Schlesser** - created project from template.

See also the list of [contributors](https://github.com/mwpd/scaffold/contributors) who participated in this project.
